...
DEFINE_VTABLE_PTR_HELPER_CTOR(UScreenshotPluginSettings);
...
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_ScreenshotPlugin_Source_ScreenshotPlugin_Public_ScreenshotPluginSettings_h__Script_ScreenshotPlugin_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UScreenshotPluginSettings, UScreenshotPluginSettings::StaticClass, TEXT("UScreenshotPluginSettings"), &Z_Registration_Info_UClass_UScreenshotPluginSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UScreenshotPluginSettings), 3483160902U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_ScreenshotPlugin_Source_ScreenshotPlugin_Public_ScreenshotPluginSettings_h__Script_ScreenshotPlugin_2511988002(TEXT("/Script/ScreenshotPlugin"),
